...
<div id="page"><div id="page2">
  ...
  <br class="clearfloat" />
    ...
    <div id="kategori">
      <div id="navigation">
        <?php 
							$kat = mysqli_query("SELECT nama_merk, merk.id_merk from merk join produk on produk.id_merk=merk.id_merk group by nama_merk");
							while($list=mysqli_fetch_array($kat)){
