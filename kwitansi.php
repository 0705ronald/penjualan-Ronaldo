...
<body bgcolor="#f9f9f9">
		<script language="javascript"> alert("Tekan CTRL+P Untuk Mencetak Kwitansi Pembelian"); </script>
		<?php
	
			require "konek_db.php";
			$panggil = mysqli_query("SELECT * FROM transaksi_detail WHERE no_tagihan='$_GET[no_tagihan]'",$konek);
			
		?>
		<div class = "menu2">
			<div class = "isi">
				<h1>Detil Kwitansi</h1>
				...
				<table style="margin:20px auto;" class = "tabel-barang" border= "1" cellspacing="0" cellpadding="50" width="700px" > 
					...
					while($row = mysqli_fetch_array($panggil)){
						...
						$a = $row['jumlah'];
						$b = $row['kd_brg'];
						$ambil = mysqli_query("SELECT * FROM barang WHERE kd_brg='$b'");
						$barang = mysqli_fetch_array($ambil);
				...
				<div style="border:1px solid black;height:auto;">
					...
					?>
						<div style="float:left; solid red;width:450px;">
							<center><h1>Detail Kwitansi</h1></center>
							<table style="10px,5px; border:0px;" border="0"  cellspacing="10" width="430px" >
								...
								<tr>			
									...
									<?php
											$ongkir = 0;
											$tampil = mysqli_query("SELECT * FROM transaksi WHERE no_tagihan = '$_GET[no_tagihan]'");
